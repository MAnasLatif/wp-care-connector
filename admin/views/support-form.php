...
<div class="wrap wp-care-wrap">
    ...
    <div class="wp-care-support-form-container">
        ...
        <form method="post" action="<?php echo esc_url( $form_data['form_action'] ); ?>" class="wp-care-support-form">
            ...
            <table class="form-table" role="presentation">
                <tbody>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="support_priority"><?php esc_html_e( 'Priority', 'wp-care-connector' ); ?></label>
                        </th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="support_message" name="support_message" rows="8" class="large-text" required placeholder="<?php esc_attr_e( 'Please describe your issue in detail. Include any error messages you see and steps to reproduce the problem.', 'wp-care-connector' ); ?>"></textarea>
                        </td>
                    </tr>
